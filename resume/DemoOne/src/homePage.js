...
//   } 
//  `,
//         <a href="#.." className="intro" style={{ width: "100px", padding: "10px" }}>
//             CSS
//     </a>
//     );
// };
    ...
    return (
        <div>
            <Navbar collapseOnSelect expand="lg" bg="dark" variant="dark" style={{ marginBottom: '0px' }}>
                <Navbar.Brand href="#home" style={{ fontSize: '20px', fontWeight: '700' }}>William Travel</Navbar.Brand>
                <Navbar.Toggle aria-controls="responsive-navbar-nav" />
                <Navbar.Collapse id="responsive-navbar-nav">
                    <Nav className="mr-auto">
                        <Nav.Link href="#features" style={{ fontSize: '16px' }}>Europe</Nav.Link>
                        <Nav.Link href="#pricing" style={{ fontSize: '16px' }}>Australia</Nav.Link>
                        <NavDropdown title="Asia" id="collasible-nav-dropdown" style={{ fontSize: '16px' }}>
                    ...
                    <Nav>
                        <Nav.Link href="#deets" style={{ fontSize: '16px' }}>More</Nav.Link>
            ...
            <div style={{ backgroundColor: "#009688" }}>
                <div class="form-group" style={{ padding: "40px" }}>
                    <Container>
                        <Row>
                            <Col xs={12} md={12}>
                                <label for="exampleInputEmail1">Search Destinations</label>
